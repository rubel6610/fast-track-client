...
const PendingRidersTable = () => {
  ...
  const handleStatusChange = async (id, status, email) => {
    ...
    if (res.data.modifiedCount > 0) {
      Swal.fire({
        icon: "success",
        title: `Rider ${status === "active" ? "accepted" : "rejected"}`,
  ...
  return (
    <div className="overflow-x-auto">
            ...
            <tr key={rider._id}>
              ...
              <td className="flex gap-2 justify-center">
                ...
                <button
                  ...
                  onClick={() =>
                    handleStatusChange(rider._id, "rejected", rider.email)
                  }
                >
                  Reject
                </button>
      ...
      {/* Modal */}
      {selectedRider && (
        <dialog open className="modal" aria-label="Rider Details Modal">
          <div className="modal-box max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
              ...
              <p>
                <strong>Bike:</strong>{" "}
                {selectedRider.bike_brand} - {selectedRider.bike_registration}
              </p>
